    ...
    public:
        ...
        void point_information(){
            ...
            if(atan2(b,a)<0){
                ...
                ROS_INFO_STREAM("theta_init " << theta_init/PI*180 << "  " << a << "  " << b);
            }
            else{
            ...
            if(atan2(d,c)<0){
                ...
                //ROS_INFO_STREAM("theta_final" << theta_final/PI*180<< "  " << c << "  " << d);
            }
            theta=abs((theta_init-theta_final));
            //ROS_INFO_STREAM("theta" << theta/PI*180);
        ...
        void matrix_init_angle(){
            for(int i=0;i<k;i++){     // 경로의 점들의 위치를 지정
                ...
                point_info[i][0]=r*cos(x);
                point_info[i][1]=r*sin(x);
